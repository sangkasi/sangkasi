...
if ( ! class_exists( 'Electronic_Supermarket_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Electronic_Supermarket_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Electronic_Supermarket_WPTT_WebFont_Loader( $url );
