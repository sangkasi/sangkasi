...
function kpcode_cre_db_posts($command) {
    ...
    foreach ( $posts as $post ) {
        ...
        $sql_backup= "INSERT INTO ".$wpdb->prefix . 'kpcode_url_posts'." (`id` ,`kpcode_post_id` ,`kpcode_post_name` ,`kpcode_type`) VALUES (NULL , '$post->ID', '$backup_postname', 'posts');";
...
ORDER BY name ASC");
        foreach ( $posts_terms as $post_terms ) {
            ...
            $sql_bp_terms = "INSERT INTO " . $wpdb->prefix . 'kpcode_url_posts' . " (`id` ,`kpcode_post_id` ,`kpcode_post_name` ,`kpcode_type`)VALUES(NULL , '$post_terms->term_id', '$backup_slug', 'terms');";
