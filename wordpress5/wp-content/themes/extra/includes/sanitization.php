...
function et_sanitize_footer_column( $choosen ) {
	return et_sanitize_key_based_option( $choosen, et_extra_footer_column_choices() );
}
...
function et_sanitize_yes_no( $choosen ) {
	return et_sanitize_key_based_option( $choosen, et_extra_yes_no_choices() );
}
...
function et_sanitize_left_right( $choosen ) {
	return et_sanitize_key_based_option( $choosen, et_extra_left_right_choices() );
}
...
function et_sanitize_divider_position( $choosen ) {
	return et_sanitize_key_based_option( $choosen, et_extra_divider_position_choices() );
}
