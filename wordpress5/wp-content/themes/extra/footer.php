	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( ' %1$s | Powered by %2$s', 'extra' ) ), '', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
...
<script type="text/javascript">
	try {
		var pageTracker = _gat._getTracker("UA-10837900-1");
